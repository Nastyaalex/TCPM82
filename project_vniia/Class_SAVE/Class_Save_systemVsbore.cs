...
namespace project_vniia
{
    ...
    {
        static void CompareRows_systemVsbore(DataTable table_del, DataTable table_in, OleDbDataAdapter adapter, DataTable table_up)
        {
        ...
        {//сравнение 2-х таблиц
            ...
            CompareRows_systemVsbore(table, table1, adapter, table_up);
